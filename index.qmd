...
ggplotly(xx, tooltip = c("x","text","causes_group"))

#plotly_json(ggplotly(xx))
...
* For *Cardiovascular diseases*, the leading cause of death, Portugal is in the quartile of countries with lowest age-standardized death rates.
